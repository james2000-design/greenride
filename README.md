...
| :---: | :---: | :---: |
| ![Splash](assets/splash-icon.png) | *[Screenshot Placeholder]* | *[Screenshot Placeholder]* |

*Note: Replace placeholders with actual screenshots from your device or emulator.*
...
```
*Note: This key is required for the Google Places Autocomplete and Map functionality.*
